...
const hardSkills = [
  ...
  { name: "Desain Grafis", icon: <FaPalette />, color: "text-pink-500", progress: "80%" },
...
const softSkills = [
  { name: "Komunikasi", icon: <FaComments />, color: "text-amber-500", progress: "95%" },
  { name: "Kerja Sama Tim", icon: <FaHandshake />, color: "text-emerald-500", progress: "95%" },
  { name: "Solusi Masalah", icon: <FaLightbulb />, color: "text-yellow-400", progress: "90%" },
